...
static int MAG_Grid(MAGtype_CoordGeodetic CoordData,
                    ...
                    struct GeoMagneticData *RecValue);

GeoMagneticData getDeclinition(const InData *input)
{
  GeoMagneticData decvalue;
...
static int MAG_Grid(MAGtype_CoordGeodetic CoordData, MAGtype_MagneticModel *MagneticModel, MAGtype_Geoid *Geoid, MAGtype_Ellipsoid Ellip, MAGtype_Date DateTime, struct GeoMagneticData *RecValue)
{
